...
function loadmap(){
	...
	searchContent += '<tr><td>Event Type: <input type="input" id="etype" value="FEAT" size="20" /></td></tr>';
...
function eventHandle(e){
	...
	//Call the searches
	//skiddle here
	skiddleresult = skiddlesearch(e.x,e.y,document.getElementById('buffersize').value,document.getElementById('etype').value);
	//Facebook here
